...
if ( Test-Path $logs_directory\exchangeServerInfo.csv ){
	...
	Export-Csv -Encoding UTF8 -noTypeInformation $logs_directory\exchangeServerInfo.csv
...
if ( Test-Path $logs_directory\exchangeServerDBInfo.csv ){
	...
	Export-Csv -Encoding UTF8 -noTypeInformation $logs_directory\exchangeServerDBInfo.csv
